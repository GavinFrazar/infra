resource "aws_iam_policy" "access" {
  ...
  path        = "/"
  description = "IAM policy for Teleport Redshift Serverless database access"
...
resource "aws_iam_policy" "discovery" {
  ...
  path        = "/"
  description = "IAM policy for Teleport Redshift Serverless database discovery"
...
module "access" {
  ...
  name                    = local.access_name
  description             = "Teleport Redshift Serverless database access"
...
module "discovery" {
  ...
  source                  = "../create-aws-iam-role"
  name                    = local.discovery_name
  description             = "Teleport Redshift Serverless database discovery"
